...
export interface IAvoidKeyboardPropTypes {
 ...
 * it's own.
 */
export class AvoidKeyboard extends React.Component<IAvoidKeyboardPropTypes> {
    static defaultProps = {
        styles: {
            alignItems: 'stretch',
    ...
    constructor(props: IAvoidKeyboardPropTypes) {
        super(props);
