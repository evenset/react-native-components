...
interface AvoidKeyboardPropTypes {
 ...
 * it's own.
 */
export default class AvoidKeyboard extends React.Component<AvoidKeyboardPropTypes> {
    static defaultProps = {
        styles: {
            alignItems: 'stretch',
    ...
    constructor(props: AvoidKeyboardPropTypes) {
        super(props);
